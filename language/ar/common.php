...
$lang = array_merge($lang, array(
	...
	'BROWSING_FORUM_GUESTS'	=> array(
		1	=> 'المستخدمون الذين يتصفحون المنتدى الآن: %2$s وزائر واحد',
		2	=> 'المستخدمون الذين يتصفحون المنتدى الآن: %2$s وزائران',
		3	=> 'المستخدمون الذين يتصفحون المنتدى الآن: %2$s و %1$d زوار',
		4	=> 'المستخدمون الذين يتصفحون المنتدى الآن: %2$s و %1$d زائراً',
		5	=> 'المستخدمون الذين يتصفحون المنتدى الآن: %2$s و %1$d زائر',
		),
	'BUTTON_EDIT'			=> 'تعديل',
	...
	'ONLINE_USERS_TOTAL'		=> array(
		1	=> 'يوجد حالياً مستخدم واحد :: %2$s و %3$s',
		2	=> 'يوجد حالياً مستخدمان :: %2$s و %3$s',
		3	=> 'يوجد حالياً <strong>%1$d</strong> مستخدمين :: %2$s و %3$s',
		4	=> 'يوجد حالياً <strong>%1$d</strong> مستخدماً :: %2$s و %3$s',
		5	=> 'يوجد حالياً <strong>%1$d</strong> مستخدم :: %2$s و %3$s',
		),
	// "... :: x registered, y hidden and z guests"
	'ONLINE_USERS_TOTAL_GUESTS'	=> array(
		1	=> 'يوجد حالياً مستخدم واحد :: %2$s، %3$s و %4$s',
		2	=> 'يوجد حالياً مستخدمان :: %2$s، %3$s و %4$s',
		3	=> 'يوجد حالياً <strong>%1$d</strong> مستخدمين :: %2$s، %3$s و %4$s',
		4	=> 'يوجد حالياً <strong>%1$d</strong> مستخدماً :: %2$s، %3$s و %4$s',
		5	=> 'يوجد حالياً <strong>%1$d</strong> مستخدم :: %2$s، %3$s و %4$s',
		),
	'OPTIONS'					=> 'خيارات',
	...
	'TOO_LONG_DATEFORMAT'			=> 'صيغة التاريخ التي أدخلتها كبيرة جداً',
	...
	'TOO_SHORT_DATEFORMAT'			=> 'صيغة التاريخ التي أدخلتها صغيرة جداً',
