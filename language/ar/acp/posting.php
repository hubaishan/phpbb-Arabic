...
$lang = array_merge($lang, array(
	...
	'BBCODE_USAGE_EXPLAIN'		=> 'هنا ستعرف كيف يستخدم BBCode، استبدل أي متغير للإدخال بالمتغير المقابل له المعرف مسبقًا (%sانظر في الأسفل%s)',
	...
	'TOKEN'					=> 'متغير معرف مسبقًا',
	'TOKENS'				=> 'متغيرات معرفة مسبقًا',
	'TOKENS_EXPLAIN'		=> 'المتغيرات المعرفة مسبقأً هي متغيرات تحمل قيمًا معينة للمطابقة في إدخال المستخدم. لو كان كود جديد يحمل أحد هذه المتغيرات فسيعرف ويطابق في إدخال المستخدم في كل ٍ من الكود المعرّف وكود الهتمل المستبدل. لو احتجت أكثر من متغير من نفس النوع تستطيع ترقيمها كالآتي: {TEXT1}, {TEXT2}.<br /><br /> داخل كود الاستبدال الهتمل تستطيع استخدام متغيرات لغوية الموجود داخل مجلد language/ مثل: {L_<em>&lt;STRINGNAME&gt;</em>} حيث إن <em>&lt;STRINGNAME&gt;</em> هو اسم المتغير اللغوي. مثلًا {L_WROTE} سوف تظهر بعد عرضها كالآتي: &quot;كتب&quot;.<br /><br /><strong> رجاءً لاحظ أن هذه المتغيرات المعرفة مسبقًا هي فقط التي يمكن استخدامها داخل أكواد التسنيق </strong>',
	'TOKEN_DEFINITION'		=> 'ماذا يمكن أن يكون؟',
	'TOO_MANY_BBCODES'		=> 'لا تستطيع إنشاء BBCodes جديدة. الرجاء حذف واحد أو أكثر من BBCodes ثم حاول مجددًا',

	'tokens'	=>	array(
		'TEXT'			=> 'أي نص، بما فيها الحروف الأجنبية، أرقام، الخ… ينبغي ألا تستعمل هذه الرموز في وسوم HTML.',
		...
		'URL'			=> 'رابط صحيح باستعمال أية بروتوكول (http، ftp، الخ… لا يمكن استعماله لحقن الجافاسكربت). إذا لم يدخَل بروتوكول فسيضاف http:// تلقائيًا',
		...
		'RELATIVE_URL'	=> 'رابط ذو صلة. يمكنك استخدام هذا الخيار لمطابقة جزء من الرابط، كن حذرًا عند استخدام الرابط الكامل للرابط ذو الصلة باستخدامك رابط منتداك. استخدم LOCAL_URL لترمز إلى منتداك.',
		...
		'ALNUM'			=> 'حروف من الأبجدية اللاتينية (A-Z) وأرقام.',
		'CHOICE'		=> 'اختيار قيمة معينة، مثلًا <samp>{CHOICE=spades,hearts,diamonds,clubs}</samp>. هذه القيم تعالج اقتراضيًّا على أنها غير متحسسة لحالة الأحرف ويمكن معالجتها على أنها متحسسة لحالة الأحرف بخيار<samp>caseSensitive</samp>: <samp>{CHOICE=Spades,Hearts,Diamonds,Clubs;caseSensitive}</samp>',
		'FLOAT'			=> 'قيمة كسر عشري, مثلا <samp>0.5</samp>.',
		'HASHMAP'		=> 'تعيين السلاسل النصية إلى بدائلها <samp>{HASHMAP=string1:replacement1,string2:replacement2}</samp>. متحسس لحالة الأحرف. يحافظ افتراضيًّا على القيم غير المعروفة .',
		'INT'			=> 'قيمة عدد صحيح، مثلا <samp>2</samp>.',
		'IP'			=> 'عنوان آي بي IPv4 أو IPv6 صحيح.',
		'IPPORT'		=> 'عنوان IPv4 أو IPv6 صحيح مع رقم المنفذ.',
		'IPV4'			=> 'عنوان آي بي IPv4 صحيح.',
		'IPV6'			=> 'عنوان  آي بي IPv6 صحيح.',
		'MAP'			=> 'تعيين النص إلى قيمة الاستبدال من <samp>{MAP=string1:replacement1,string2:replacement2}</samp>. غير متحسس لحالة الأحرف. يحافظ على القيم غير المعروفة افتراضيًّا.',
		'RANGE'			=> 'السماح بالأعداد الصحيحة في نطاق، مثلا <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'التحقق من القيمة بأحرف بدل، مثلا <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		'TIMESTAMP'		=> 'نقطة زمنية مثل <samp>1h30m10s</samp> والتي ستحول إلى عدد صحيح من الثواني. تقبل الأرقام أيضا.',
		'UINT'			=> 'عدد طبيعي. مثل <samp>{INT}</samp>ولكن يرفض القيم التي تقل عن 0.',
		),
));

// Smilies and topic icons
$lang = array_merge($lang, array(
	'ACP_ICONS_EXPLAIN'		=> 'من هذه الصفحة تستطيع إضافة الأيقونات التي قد يستعملها الأعضاء عند إرسال مواضيعهم ومشاركاتهم أو حذفها أوتعديلها. هذه الأيقونات عادة ما تعرَض بجوار عنوان الموضوع في المنتدى، أو عناوين المشاركات في صفحة الموضوع. تستطيع أيضًا إنشاء وتركيب حزم جديد من الايقونات',
	'ACP_SMILIES_EXPLAIN'	=> 'الابتسامات عادةً ما تكون عبارة عن صور صغيرة ومتحركة تستخدم للتعبير عن الأحاسيس والمشاعر. من هذه الصفحة تستطيع إضافة، حذف وتعديل الابتسامات التي سيستعملها الأعضاء في مشاركاتهم ورسائلهم الخاصة. تستطيع أيضًا إنشاء حزم جديدة من الابتسامات وتركيبها',
	...
	'ICONS_ADDED'			=> array(
		0	=> 'لم يتم إضافة أية أيقونات.',
		1	=> 'تمت إضافة الأيقونة بنجاح.',
		2	=> 'تمت إضافة الأيقونتين بنجاح.',
		3	=> 'تمت إضافة الأيقونات بنجاح.',
		4	=> 'تمت إضافة الأيقونات بنجاح.',
		5	=> 'تمت إضافة الأيقونات بنجاح.',
		6	=> 'لم يتم إضافة أية أيقونات.',
		),
	'ICONS_CONFIG'			=> 'إعدادات الايقونة',
	'ICONS_DELETED'			=> 'تم حذف الأيقونة بنجاح',
	'ICONS_EDIT'			=> 'تعديل الأيقونة',
	'ICONS_EDITED'			=> array(
		0	=> 'لم يتم تحديث أية أيقونات.',
		1	=> 'تم تحديث الأيقونة بنجاح.',
		2	=> 'تم تحديث الأيقونتين بنجاح.',
		3	=> 'تم تحديث الأيقونات بنجاح.',
		4	=> 'تم تحديث الأيقونات بنجاح.',
		5	=> 'تم تحديث الأيقونات بنجاح.',
		6	=> 'لم يتم تحديث أية أيقونات.',
		),
	...
	'SMILIES_ADDED'				=> array(
		0	=> 'لم يتم إضافة أية ابتسامات.',
		1	=> 'تمت إضافة الابتسامة بنجاح.',
		2	=> 'تمت إضافة الابتسامتين بنجاح.',
		3	=> 'تمت إضافة الابتسامات بنجاح.',
		4	=> 'تمت إضافة الابتسامات بنجاح.',
		5	=> 'تمت إضافة الابتسامات بنجاح.',
		6	=> 'لم يتم إضافة أية ابتسامات.',
		),
	...
	'SMILIES_EDITED'			=> array(
		0	=> 'لم يتم تحديث أية ابتسامات.',
		1	=> 'تم تحديث الابتسامة بنجاح.',
		2	=> 'تم تحديث الابتسامتين بنجاح.',
		3	=> 'تم تحديث الابتسامات بنجاح.',
		4	=> 'تم تحديث الابتسامات بنجاح.',
		5	=> 'تم تحديث الابتسامات بنجاح.',
		6	=> 'لم يتم تحديث أية ابتسامات.',
		),
	...
	'TOO_MANY_SMILIES'			=> array(
		1	=> 'تم الوصول للحد الأقصى من الابتسامات وهو ابتسامة واحدة.',
		2	=> 'تم الوصول للحد الأقصى من الابتسامات وهو ابتسامتين.',
		3	=> 'تم الوصول للحد الأقصى من الابتسامات وهو %d ابتسامات.',
		4	=> 'تم الوصول للحد الأقصى من الابتسامات وهو %d ابتسامة.',
		5	=> 'تم الوصول للحد الأقصى من الابتسامات وهو %d ابتسامة.',
		),
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'من هذه اللوحة تستطيع إضافة الكلمات التي سوف تحجب تلقائيا في المنتديات أو تعديلها أو حذفها. أيضًا لن يستطيع الأشخاص التسجيل بأسماء تحتوي على هذه الكلمات. العلامة الشاملة (*) يمكن استخدامها أيضًا، على سبيل المثال: *سلام* تطابق كلمة الإسلامي، سلام* تطابق كلمة سلامي، *سلام تطابق كلمة الإسلام',
...
// Ranks
$lang = array_merge($lang, array(
	'ACP_RANKS_EXPLAIN'		=> 'باستعمال هذا النموذج تستطيع إضافة الرتب أو تعديلها أو مشاهدتها أو حذفها. تستطيع أيضًا إنشاء رتب خاصة والتي يمكن إعطاؤهها لعضو بسهولة عبر إدارة الأعضاء',
	...
	'NO_UPDATE_RANKS'		=> 'حذفت الرتبة بنجاح. مع ذلك فإن العضويات التي تستخدم هذه الرتبة لم تحدث، تحتاج إلى إعادة ضبط الرتبة لهؤلاء الأعضاء يدويًا',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'هنا تستطيع التحكم بالأسماء الممنوعة من الاستعمال. يمكنك أيضًا استخدام العلامة الشاملة (*) في الأسماء.',
...
$lang = array_merge($lang, array(
	...
	'IS_NOT_TRANSLATED'			=> 'السبب <strong>ليس</strong> محليًا',
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'السبب <strong>ليس</strong> محليًا. إذا أردت إضافة النموذج المحلي، عليك بتحديد المفتاح الصحيح من ملفات اللغة في قسم أسباب التقارير',
	...
	'REASON_ALREADY_EXIST'		=> 'هناك سبب بهذا العنوان مسبقًا، يرجى اختيار عنوان آخر لهذا السبب',
