...
$lang = array_merge($lang, array(
	...
	'HELP_BBCODE_TEXT_BASIC_ANSWER'	=> 'تشمل BBCode علامات تجعلك تغير تنسيق النص بسرعة. تستطيع عمل ذلك بالطرق التالية: <ul><li>لجعل جزء من النص سميكًا ضعه بين العلامة <strong>[b][/b]</strong>، مثلًا <br /><br /><strong>[b]</strong>أهلًا<strong>[/b]</strong><br /><br />سوف تصبح <strong>أهلًا</strong></li><li>للنص المسطر <strong>[u][/u]</strong>، مثلًا:<br /><br /><strong>[u]</strong>صباح الخير<strong>[/u]</strong><br /><br />تصبح <span style="text-decoration: underline">صباح الخير</span></li><li>لجعل الخط مائل <strong>[i][/i]</strong>، مثلًا<br /><br />هذا <strong>[i]</strong>عظيم!<strong>[/i]</strong><br /><br />سوف يعطيك هذا <i>عظيم!</i></li></ul>',
	'HELP_BBCODE_TEXT_BASIC_QUESTION'	=> 'كيفية كتابة نص عريض أو مائل أو تحته خط',
	'HELP_BBCODE_TEXT_COLOR_ANSWER'	=> 'لتغيير لون وحجم الخط يمكنك استخدام التالي. لا تنسى أن شكل ولون النص يعتمد على برنامج المتصفح وجهازه: <ul><li>لتغيير اللون ضع النص بين الدوال <strong>[color=][/color]</strong>. تستطيع استخدام أي من الألوان المتعارف عليها (eg. red, blue, yellow, etc.) أو طريقة الأرقام الثلاثة الست عشرية، eg. #FFFFFF, #000000. مثلًا، لجعل لون النص أحمر تستطيع استخدام:<br /><br /><strong>[color=red]</strong>أهلًا!<strong>[/color]</strong><br /><br />أو<br /><br /><strong>[color=#FF0000]</strong>أهلًا!<strong>[/color]</strong><br /><br />جميعهم سوف يظهرون <span style="color:red">أهلًا!</span></li><li>لتغيير حجم الخط نستطيع بطريقة مماثلة استخدام <strong>[size=][/size]</strong>. هذه الدالة سوف تعتمد على القالب المستخدم لكن الطريقة المفضلة هي استخدام نظام النقط في حجم النص، ابتداء من 1 (صغير إلى أقصى درجة) إلى الرقم 29 (كبير جدًا). مثلًا:<br /><br /><strong>[size=9]</strong>صغير<strong>[/size]</strong><br /><br />سوف تكون <span style="font-size:30%;">صغير</span><br /><br />حيث:<br /><br /><strong>[size=24]</strong>ضخم!<strong>[/size]</strong><br /><br />ستكون <span style="font-size:200%;">ضخم!</span></li></ul>',
	'HELP_BBCODE_TEXT_COLOR_QUESTION'	=> 'كيفية القيام بتغيير لون النص أو حجمه',
	'HELP_BBCODE_TEXT_COMBINE_ANSWER'	=> 'نعم، بالطبع تستطيع ذلك، مثلًا لتلفت انتباه شخص ما تستطيع استخدام:<br /><br /><strong>[size=200][color=red][b]</strong>أنظر إلىّ!<strong>[/b][/color][/size]</strong><br /><br />هذا سوف يظهر <span style="color:red;font-size:200%;"><strong>أنظر إلىّ!</strong></span><br /><br />لكننا لا ننصح بكتابة الكثير من تلك الدوال! على الكاتب التأكد من إغلاق الإشارات بطريقة صحيحة، تذكر الأمر يعود إليك. مثلًا الآتي غير صحيح:<br /><br /><strong>[b][u]</strong>هذا خطأ<strong>[/b][/u]</strong>',
