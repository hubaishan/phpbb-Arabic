...
$lang = array_merge($lang, array(
	...
	'ADD_POLL_EXPLAIN'			=> 'إذا كنت لا تريد إضافة استطلاع اترك هذا الحقل فارغًا',
	'ALREADY_DELETED'			=> 'عفوًا ولكن هذه الرسالة قد حذفت للتو',
	'ATTACH_COMMENT_NO_EMOJIS'	=> 'تعليق المرفق يحتوي على حروف محظورة (أيموجي).',
	...
	'DELETE_TOPIC_PERMANENTLY'	=> array(
		1	=> 'حذف هذا الموضوع نهائيًا بحيث لا يمكن استعادته',
	...
	'LOGIN_EXPLAIN_SOFT_DELETE'	=> 'ينبغي تسجيل الدخول قبل الحذف البسيط للمشاركة من هذا المنتدى.',
	...
	'NO_DELETE_POLL_OPTIONS'	=> 'لا يمكنك حذف خيارات الاستطلاع',
	'NO_PM_ICON'				=> 'بدون أيقونة',
	'NO_POLL_TITLE'				=> 'ينبغي إدخال سؤال الاستطلاع',
	...
	'POLL_FOR'					=> 'زمن الاستطلاع',
	'POLL_FOR_EXPLAIN'			=> 'أدخل 0 أو اتركه فارغًا لجعل الاستطلاع للأبد',
	...
	'POLL_TITLE_TOO_LONG'		=> 'عنوان الاستطلاع ينبغي أن يحتوي على الأقل 100 حرف',
	'POLL_TITLE_COMP_TOO_LONG'	=> 'عنوان الاستطلاع كبير جدًا ، نقترح إزالة الابتسامات',
	...
	'TOO_FEW_POLL_OPTIONS'		=> 'ينبغي إدخال خيارين في الاستطلاع على الأقل',
	...
	'TOO_MANY_POLL_OPTIONS'		=> 'لقد أدخلت خيارات استطلاع كثيرة جدًا',
	...
	'TOO_MANY_USER_OPTIONS'		=> 'لا يمكنك إضافة خيارات أخرى للاستطلاع',
