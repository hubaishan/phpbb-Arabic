...
$lang = array_merge($lang, array(
	...
	'CONFIRM_SEARCH_BACKEND'				=> 'هل أنت متأكد من أنك تريد التحويل إلى خلفية بحث أخرى؟ بعد تغير خلفية البحث عليك أن تنشئ فهرسة لخلفية البحث الجديدة. إذا لم تكن تنوي الرجوع إلى خلفية البحث القديمة يمكنك أيضًا إزالة فهرسة خلفية البحث القديمة لتحرير موارد النظام',
	'CONTINUE_DELETING_INDEX'				=> 'الاستمرار في عملية إزالة الفهرس السابق',
	'CONTINUE_DELETING_INDEX_EXPLAIN'		=> 'لقد حدثت عملية إزالة فهرسة سابقًا. لكي تصل إلى صفحة فهرسة البحث عليك أن تنهي العملية أو تلغيها',
	...
	'FULLTEXT_SPHINX_HOST_EXPLAIN'			=> 'المستضيف الذي يسمع عليه الملف الخفي لبحث sphinx. أتركه فارغًا لاستعمال localhost الافتراضي',
	'FULLTEXT_SPHINX_INDEXER_MEM_LIMIT'		=> 'حد الذاكرة للفهرسة',
	'FULLTEXT_SPHINX_INDEXER_MEM_LIMIT_EXPLAIN'	=> 'هذا الرقم يجب دومًا أن يكون أقل من الذاكرة العشوائية المتوفرة في جهازك. إذا كان هناك مشاكل دورية في الأداء فربما يكون هذا بسبب أن الفهرسة تستهلك الكثير من الموارد. قد يساعدك أن تقوم بتقليل كمية الذاكرة المتاححة للفهرسة.',
	'FULLTEXT_SPHINX_MAIN_POSTS'			=> 'عدد المشاركات في الفهرس الرئيسي',
	'FULLTEXT_SPHINX_PORT'					=> 'منفذ الملف الخفي لبحث sphinx',
	'FULLTEXT_SPHINX_PORT_EXPLAIN'			=> 'المنفذ الذي يسمع عليه الملف الخفي لبحث sphinx. أتركه فارغًا لاستعمال المنفذ الافتراضي لـ Sphinx API رقم 9312',
	...
	'INDEXING_IN_PROGRESS'					=> 'جاري الفهرسة حاليًا',
	'INDEXING_IN_PROGRESS_EXPLAIN'			=> 'خلفية البحث حاليًا تفهرس كل المشاركات في هذا المنتدى. قد يستغرق هذا بضع دقائق إلى بضع ساعات بحسب حجم المنتدى الخاص بك',
	...
	'MIN_SEARCH_AUTHOR_CHARS_EXPLAIN'		=> 'على المستخدم أن يضع على الأقل هذا العدد من الحروف عن استعمال خاصية البحث لاستعمال علامة شاملة للبحث عن مستخدم. إذا كان اسم مستخدم للكاتب أصغر من هذا الرقم فيمكنك إجراء عملية البحث هذه بإدخال اسم المستخدم كاملًا',
	...
	'SEARCH_INDEX_CREATE_REDIRECT'			=> array(
		1	=> 'تمت فهرسة جميع المشاركات حتى المشاركة رقم %2$d، منها (%1$d)مشاركة واحدة تمت فهرستها في هذه الخطوة.',
		2	=> 'تمت فهرسة جميع المشاركات حتى المشاركة رقم %2$d، منها (%1$d) مشاركتان تمت فهرستهما في هذه الخطوة.',
		3	=> 'تمت فهرسة جميع المشاركات حتى المشاركة رقم %2$d، منها %1$d مشاركات تمت فهرستهم في هذه الخطوة.',
		4	=> 'تمت فهرسة جميع المشاركات حتى المشاركة رقم %2$d، منها %1$d مشاركة تمت فهرستهم في هذه الخطوة.',
		5	=> 'تمت فهرسة جميع المشاركات حتى المشاركة رقم %2$d، منها %1$d مشاركة تمت فهرستهم في هذه الخطوة.',
		),
	'SEARCH_INDEX_CREATE_REDIRECT_RATE'		=> array(
		2	=> 'المعدل الحالي للفهرسة يبلغ تقريبًا %1$.1f مشاركة في الثانية.',
		),
	'SEARCH_INDEX_DELETE_REDIRECT'			=> array(
		1	=> 'تم حذف جميع المشاركات حتى المشاركة %2$d من فهرس البحث، منها (%1$d) مشاركة واحدة في هذه الخطوة',
		2	=> 'تم حذف جميع المشاركات حتى المشاركة %2$d من فهرس البحث، منها (%1$d) مشاركتان في هذه الخطوة',
		3	=> 'تم حذف جميع المشاركات حتى المشاركة %2$d من فهرس البحث، منها %1$d مشاركات في هذه الخطوة',
		4	=> 'تم حذف جميع المشاركات حتى المشاركة %2$d من فهرس البحث، منها %1$d مشاركة في هذه الخطوة',
		5	=> 'تم حذف جميع المشاركات حتى المشاركة %2$d من فهرس البحث، منها %1$d مشاركة في هذه الخطوة',
		),
	'SEARCH_INDEX_DELETE_REDIRECT_RATE'		=> array(
		2	=> 'نسبة الحذف هي تقريبًا %1$.1f مشاركة في الثانية.',
		),
	'SEARCH_INDEX_CREATED'					=> 'تفهرست المشاركات كلها في قاعدة البيانات بنجاح',
	'SEARCH_INDEX_PROGRESS'					=> 'تم: %1$d | متبقي: %2$d | الإجمالي: %3$d',
	...
	'SEARCH_TYPE_EXPLAIN'					=> 'منتديات phpBB تسمح لك باختيار الخلفية المستعملة للبحث عن النصوص في المشاركات. افتراضيًا البحث سيستعمل خلفية fulltext لـ phpBB',
