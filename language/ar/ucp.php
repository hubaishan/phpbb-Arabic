...
$lang = array_merge($lang, array(
	...
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'إذا كان حسابك موجودًا فإن كلمة مرور جديدة تم إرسالها إلى بريدك المسجل لدينا، إذا لم تستلم البريد فربما يكون ذلك بسبب: حظرك، أو عدم تفعيل حسابك، أو عدم السماح لك بتغيير كلمة المرور، تواصل من مدير الموقع لتتبين ما هي الأسباب، كما ينبغي عليك الاطلاع على قسم البريد الغير هام (spam)',
