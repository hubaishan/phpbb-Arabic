...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'التفاصيل هنا تعرف المعلومات التي تستعمل لإرسال ملفات تعريف الارتباط (الكوكيز) إلى متصفح المستخدم. في معظم الأوقات الإعدادت الحالية تفي بالغرض. لكن إذا أردت أن تقوم بتعديلات اعملها بحذر. الإعدادت الخاطئة قد تمنع المستخدمين من تسجيل الدخول',
...
$lang = array_merge($lang, array(
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'تفعيل مؤشر رسائل خاصة دقيق في صفحة الموضوع',
