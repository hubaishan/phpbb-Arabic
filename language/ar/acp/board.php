...
$lang = array_merge($lang, array(
	...
	'ENABLE_EMAIL_EXPLAIN'			=> 'إذا تم تعطيل هذه الميزة فلن يتم إرسال رسائل بريدية عن طريق المنتدى نهائيًا.<br><em>يرجى ملاحظة أن تفعيل عضويات المستخدمين والمدير يتطلب أن تكون هذه الميزة مفعلة. إذا قمت باختيار "المستخدم" أو "المدير" في إعدادات التسجيل، فإن تعطيل هذه الميزة سيقوم بتعطيل التسجيل.</em>',
