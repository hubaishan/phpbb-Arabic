...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'هنا تستطيع أخذ نسخة احتياطية من البيانات كلها المتعلقة بـ phpBB. سيتم تخزين الأرشيف الناتج في مجلد <samp>store/</samp>. تبعًا لإعدادات الخادم لديك تستطيع ضغط الملف على عدة صيغ.',
	'ACP_RESTORE_EXPLAIN'	=> 'هذه الصفحة تساعدك في عمل استعادة كاملة لجميع جداول phpBB من الملف المحفوظ. إذا كان الخادم الخاص بك يدعم ضغط الملفات ستستطيع رفع ملف نصي مضغوط بصيغة gzip أو bzip2 وسيتم إلغاء الضغط تلقائيًا. <strong>تحذير</strong> سيؤدي هذا إلى الكتابة فوق البيانات الحالية. الاستعادة قد تأخذ وقتًا طويلًا، رجاءًا لا تغلق الصفحة حتى الانتهاء من العملية. النسخ الاحتياطية تتخزن في مجلد <samp>store/</samp> ويفترض بها أن تكون متولدة عن طريق خاصية النسخ الاحتياطي في phpBB. محاولة استرجاع نسخة احتياطية متولدة بواسطة نظام آخر قد ينجح وقد لا ينجح',

	'BACKUP_DELETE'			=> 'حُذفَت ملف النسخة الاحتياطية لقاعدة البيانات بنجاح',
	'BACKUP_INVALID'		=> 'الملف المحدد للإستعادة غير صالح',
	'BACKUP_NOT_SUPPORTED'	=> 'النسخ الاحتياطي المختار غير مدعوم',
	...
	'RESTORE_FAILURE'		=> 'قد يكون ملف النسخة الاحتياطية معطوبًا',
	...
	'STORE_LOCAL'			=> 'تخزين الملفات محليًا',
