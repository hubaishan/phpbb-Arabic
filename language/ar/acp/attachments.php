...
$lang = array_merge($lang, array(
	...
	'IMAGE_QUALITY'				=> 'جودة مرفقات الصور المرفوعة (JPEG فقط)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'حدد قيمة بين 50% (حجم ملف أقل) و 90% (جودةأعلى). الجودة الأعلى من 90% تضخم حجم الملف وهي غير مفعلة. الإعدادات تعمل في حالة إذا كانت أبعاد الصورة معينة إلى قيمة غير   0 px في 0px.',
	'IMAGE_STRIP_METADATA'		=> 'عزل بيانات أوصاف الصورة (JPEG only)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'عزل بيانات أوصاف الصورة مثل: المصور و الموقع الجغرافي ومواصفات الكاميرا. الإعدادات تعمل في حالة إذا كانت أبعاد الصورة معينة إلى قيمة غير   0 px في 0px.',
	...
	'UPLOAD_POST_NOT_EXIST'			=> 'الملف  “%1$s” لا يمكن نشره في المشاركة رقم %2$d حيث المشاركة غير موجودة.',
));
