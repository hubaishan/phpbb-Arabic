...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> 'من هذه الصفحة تستطيع إدارة المجموعات كلها، تستطيع حذف وإنشاء وتعديل أي مجموعة موجودة. ولك أن تختار رؤساء المجموعة، أيضًا خاصية فتح/غلق/إخفاء المجموعة ووضع اسم المجموعة مع الوصف',
	...
	'GROUP_COLOR_EXPLAIN'			=> 'تحديد لون "اسم المستخدم" الذي سيتلون به الأعضاء، إذا أردت الافتراضي اتركه فارغًا',
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'هل أنت متأكد أنك تريد إضافة العضو %2$s إلى المجموعة؟',
		2	=> 'هل أنت متأكد أنك تريد إضافة العضوين %2$s إلى المجموعة؟',
		3	=> 'هل أنت متأكد أنك تريد إضافة الأعضاء %2$s إلى المجموعة؟',
		4	=> 'هل أنت متأكد أنك تريد إضافة الأعضاء %2$s إلى المجموعة؟',
		5	=> 'هل أنت متأكد أنك تريد إضافة الأعضاء %2$s إلى المجموعة؟',
		),
	...
	'GROUP_EDIT_EXPLAIN'			=> 'هنا تستطيع تعديل مجموعة موجودة. تستطيع تغيير اسمها ووصفها ونوعها (مفتوحة، مغلقة، ..وهكذا.). تستطيع أيضا تحديد خيارات خاصة للمجموعة مثل اللون، الرتبة، وغيرها. التغييرات التي تجري هنا تلغي كل الإعدادات الحالية للمستخدمين. يرجى ملاحظة أن أعضاء المجموعة يستطيعون تغيير صورهم الرمزية ما لم تضبط الصلاحيات المناسبة لمنع ذلك',
	'GROUP_ERR_USERS_EXIST'			=> 'الأعضاء المحددون موجودون سابقًا في هذه المجموعة',
	'GROUP_FOUNDER_MANAGE'			=> 'إدارة من المؤسس فقط',
	'GROUP_FOUNDER_MANAGE_EXPLAIN'	=> 'تقييد إدارة هذه المجموعة للمؤسسين فقط. المستخدمون الذين يمتلكون صلاحيات المجموعات يستطيعون رؤية هذه المجموعة كما هو الحال أيضًا مع أعضاء هذه المجموعة',
	'GROUP_HIDDEN'					=> 'مخفية',
	...
	'GROUP_MEMBERS_EXPLAIN'			=> 'هذه لائحة بأعضاء هذه المجموعة كلهم. تحتوي على جداول متفرقة للرؤساء والمنتظرين الموافقة والأعضاء. من هنا تستطيع إدارة جوانب العضويات جميعها ودورها في هذه المجموعة. لحذف رئيس المجموعة وإبقاءه عضوا في المجموعة استعمل إلغاء رئاسة المجموعة بدلًا من الحذف. كما تستطيع استخدام ترقية لجعل عضوية عادية رئيسًا للمجموعة',
	...
	'GROUP_NAME_TAKEN'				=> 'اسم المجموعة الذي استعملته موجود مسبقًا، رجاءً اختر اسمًا آخر',
	'GROUP_OPEN'					=> 'مفتوحة',
	...
	'GROUP_USERS_REMOVE'			=> 'حـُذفَ الأعضاء المحددون من المجموعة وضُبطت الافتراضيات بنجاح',
	'GROUP_USERS_INVALID'			=> 'لم يتم إضافه أي مستخدمين إلى المجموعة حيث أن هؤلاء الأعضاء غير موجودين: %s',
	...
	'PENDING_MEMBERS'			=> 'قيد الانضمام',

	'SELECT_GROUP'				=> 'اختيار مجموعة',
	'SPECIAL_GROUPS'			=> 'مجموعات معرفة مسبقًا',
	'SPECIAL_GROUPS_EXPLAIN'	=> 'المجموعات المعرفة سابقًا عبارة عن مجموعات خاصة، لا تستطيع حذفها أو تعديلها مباشرة. ولكن بإمكانك إضافة الأعضاء وتعديل الخيارات الأساسية',
	...
	'TEAMPAGE_FORUMS_EXPLAIN'	=> 'إذا تم اختيار نعم، سيتم وضع قائمة أمام المشرفين بالمنتديات التي يملكون عليها صلاحية الإشراف. قد يكون هذا ثقيلًا على قاعدة البيانات في المنتديات الضخمة.',
	...
	'USER_DEF_GROUPS_EXPLAIN'		=> 'المجموعات التالية تم إنشائها من طرفك أو من طرف مدير آخر. تستطيع إدارة الأعضاء كما تستطيع أيضًا تعديل خصائص المجموعة أو حتى حذفها',
	...
	'USER_GROUP_LEADER'				=> 'تحديد رئيسًا للمجموعة',
));
