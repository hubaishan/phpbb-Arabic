...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'هنا تستطيع أخذ نسخة احتياطية من المحتويات كلها المتعلقة بـ phpBB. تستطيع تخزين أرشيف النتائج في مجلد <samp>store/</samp> أو تحميلها مباشرة. تبعًا لإعدادات الخادم لديك تستطيع ضغط الملف على عدة أشكال',
