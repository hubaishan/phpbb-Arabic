...
// Forum Pruning
$lang = array_merge($lang, array(
	'ACP_PRUNE_FORUMS_EXPLAIN'	=> 'هذه ستحذف أي موضوع لم يشارَك فيه أو يشاهَد بدءًا من عدد الأيام التي ستحددها إذا لم تدخِل أي رقم فستحذف المواضيع كلها. افتراضيًا لن تحذف مواضيع الاستفتاءات التي ما زالت نشطة، ولن تحذف المواضيع المثبتة والإعلانات',
