...
$lang = array_merge($lang, array(
	...
	'AVATAR_WRONG_SIZE'				=> 'عرض الصورة المقدّمة هو %5$s بكسل وطولها %6$s بكسل .ينبغي أن يكون عرض الصورة الرمزية على الأقل %1$s بكسل، وطولها %2$s بكسل وعلى الأكثر يكون عرضها %3$s بكسل وطولها %4$s بكسل.',
