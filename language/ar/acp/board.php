...
$lang = array_merge($lang, array(
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'مسار تحت المنتدى إلى معرض الصور الرمزية مثال <samp>images/avatars/gallery</samp>',
...
$lang = array_merge($lang, array(
	...
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'يتطلب التحقق من شهادة SSL المستخدمة من قبل خادم SMTP.<em><strong>تحذير:</strong> الاتصال المناظر مع شهادات SSL غير متحقق منها قد يسبب آثارًا أمنية. </em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'التحقق من اسم نظير SMTP',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'يتطلب التحقق من اسم النظير لخادمات SMTP باستخدام اتصالات SSL/TLS.<em><strong>تحذير :</strong> الاتصال بالنظائر غير المتحقق منها قد يسبب آثارًا أمنية. </em>',
...
// Jabber settings
$lang = array_merge($lang, array(
	'ACP_JABBER_SETTINGS_EXPLAIN'	=> 'من هنا تستطيع تفعيل خاصية المراسلة الفورية وتنبيهات المنتدى بالبروتوكول Jabber، Jabber هو بروتكول مفتوح المصدر ويمكن استخدامه من اي شخص، بعض خدمات Jabber توفر منافذ أو طرق تمكنك من محادثه مستخدمين على شبكات اخرى. ليس كل الخوادم توفر منافذ خارجيه، لذا كن حذرًا من تغيير البروتكول لان التغيير قد تمنع الخدمات من التشغيل. وكن متأكد من وضع معلومات حسابك المسجل، وسوف نستخدمه بالتنبيهات والمراسلة في phpbb',

	'JAB_ALLOW_SELF_SIGNED'			=> 'السماح بشهادات SSL الموقعة ذاتيًا',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'السماح بالاتصالات بخادم Jabber بشهادة SSL موقعة ذاتيا.<em><strong>تحذير:</strong> السماح لشهادات SSL موقعة ذاتيًا قد يسبب آثارًا أمنية.</em>',
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'يتطلب التحقق من شهادة SSL المستخدمة من قبل خادم Jabber.<em><strong>تحذير:</strong> الاتصال النظائر مع شهادات SSL غير متحقق منها قد يسبب آثارًا أمنية.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'التحقق من اسم نظير Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'يتطلب التحقق من اسم النظير لخادمات Jabber باستخدام اتصالات SSL/TLS.<em><strong>تحذير :</strong> الاتصال بالنظائر الغير متحقق منها قد يسبب آثارًا أمنية.</em>',
));
