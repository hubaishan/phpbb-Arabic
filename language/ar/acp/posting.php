...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		'TEXT'			=> 'أي نص، بما فيها الحروف الأجنبية، أرقام، الخ… ينبغي ألا تستعمل هذه الرموز في وسوم HTML. بدلًا عن ذلك حاول استعمال IDENTIFIER أو SIMPLETEXT',
		...
		'URL'			=> 'رابط صحيح باستعمال بروتوكول (http، ftp، الخ… لا يمكن استعمال لحقن الجافاسكربت). إذا لم يدخَل بروتوكول فسيضاف http:// تلقائيًا',
