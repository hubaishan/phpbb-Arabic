...
$lang = array_merge($lang, array(
	...
	'STEP_3_EXPLAIN_CREATE'			=> 'بما أنك تملك أكثر من لغة منصبة في المنتدى، عليك ملء لغات عناصر التذكير كذلك. حقل الملف الشخصي سيعمل مع اللغة الافتراضية المفعلة، يمكن ملء عناصر لغة التذكير لاحقًا أيضًا',
