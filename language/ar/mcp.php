...
$lang = array_merge($lang, array(
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'استخدم النموذج الآتي لإبلاغ عن الرسالة الخاصة، ينبغي الإبلاغ فقط عن الرسائل المخالفة لشروط المنتدى. <strong>ملاحظة: التبليغ عن الرسالة الخاصة يسمح للمشرف العام أو المدير بقراءتها </strong>',
	'REPORT_NOTIFY'				=> 'أبلغني',
	'REPORT_NOTIFY_EXPLAIN'		=> 'يتم إبلاغك عند التعامل مع تبليغك',
	'REPORT_POST_EXPLAIN'		=> 'استخدم النموذج الآتي للإبلاغ عن المشاركات، ينبغي الإبلاغ فقط عن المشاركات المخالفة لشروط المنتدى',
	...
	'UNAPPROVED_POSTS_TOTAL'		=> array(
		...
		1	=> 'توجد مشاركة واحدة تنتظر الموافقة عليها.',
