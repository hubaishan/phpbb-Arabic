...
$lang = array_merge($lang, array(
	...
	<br />
	هذا المنتدى يستعمل الـ cookies لتخزين معلومات على جهازك. هذه الـ cookies لا تحمل أية معلومات أدخِلت في الأعلى، إنما فائدتها فقط لتحسين متعة التصفح في المنتدى. يستعمل بريدك الإلكتروني لتأكيد عملية تسجيلك في المنتدى ولإرسال كلمة المرور الخاصة بك في حالة نسيانها.
	<br />
...
$lang = array_merge($lang, array(
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'الحقل “%2$s” قصير جداً، على الأقل يجب أن يكون فيه حرفاً واحداً.',
		2	=> 'الحقل “%2$s” قصير جداً، على الأقل يجب أن يكون فيه حرفان.',
		3	=> 'الحقل “%2$s” قصير جداً، على الأقل يجب أن يكون فيه %1$d حروف.',
		4	=> 'الحقل “%2$s” قصير جداً، على الأقل يجب أن يكون فيه %1$d حرفاً.',
		5	=> 'الحقل “%2$s” قصير جداً، على الأقل يجب أن يكون فيه %1$d حرف.',
		),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'الحقل “%2$s” طويل جداً، غير مسموح بأكثر من حرف واحد.',
		2	=> 'الحقل “%2$s” طويل جداً، غير مسموح بأكثر من حرفان.',
		3	=> 'الحقل “%2$s” طويل جداً، غير مسموح بأكثر من %1$d حروف.',
		4	=> 'الحقل “%2$s” طويل جداً، غير مسموح بأكثر من %1$d حرفاً.',
		5	=> 'الحقل “%2$s” طويل جداً، غير مسموح بأكثر من %1$d حرف.',
		),
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'لديك حالياً رسالة خاصة بالانتظار لأن مجلد رسائلك ممتلئ تماماً.',
		2	=> 'لديك حالياً رسالتان خاصتان بالانتظار لأن مجلد رسائلك ممتلئ تماماً',
		3	=> 'لديك حالياً %d رسائل خاصة بالانتظار لأن مجلد رسائلك ممتلئ تماماً',
		4	=> 'لديك حالياً %d رسالة خاصة بالانتظار لأن مجلد رسائلك ممتلئ تماماً',
		),
