...
$lang = array_merge($lang, array(
	...
	'ALWAYS_TODAY'			=> 'دائمًا الوقت الحالي',
	...
	'DISPLAY_AT_REGISTER_EXPLAIN'	=> 'إذا تم تفعيل هذا الخيار، فإن الحقل سوف يعرض أثناء التسجيل ويكون قابلًا للتغيير من لوحة تحكم العضو',
	...
	'EDIT_DROPDOWN_LANG_EXPLAIN'	=> 'الرجاء الانتباه بأنك قادر على تغيير نص الخيارات وأيضا يمكنك إضافة خيارات جديدة إلى ما لا نهاية. وليس من الجيد إضافة خيارات جديدة بين الخيارات الموجودة فهذا قد ينتج في اختيارات خاطئة للأعضاء، ويمكن أيضا إن حذفت خيارات بعد حذف الخيارات الموجودة مسبقًا. حذف الخيارات الأخيرة ينتج عنه تحول الأعضاء إلى الخيارات الافتراضية',
	...
	'HIDE_PROFILE_FIELD_EXPLAIN'	=> 'إخفاء حقل الملف الشخصي عن كل الأعضاء عدا المديرين والمشرفين، الذين باستطاعتهم رؤية هذا الحقل، إذا لم يفعل خيار العرض في لوحة التحكم فإن المستخدم لا يستطيع رؤية أو تعديل هذا الحقل، وسيكون تغيير هذا الحقل حكرًا على المديرين.',
	...
	'LETTER_NUM_PUNCTUATION'	=> 'أي حروف، أرقام، فواصل، نقاط، شرطة سفلية وشرطة بادئًا بأي حرف',
	...
	'STEP_1_EXPLAIN_CREATE'			=> 'هنا يمكنك إدخال أول الخيارات الأساسية لحقلك الجديد للملف الشخصي. هذه البيانات مطلوبة من أجل الخطوة التالية بحيث يمكنك وضع بقية الخيارات وتحسين حقلك للملف الشخصي أكثر',
	...
	'STEP_2_EXPLAIN_EDIT'			=> 'هنا أنت قادر على تحديد بعض الخيارات الواسعة.<br /><strong>الرجاء تسجيل أن التعديلات على حقل الملف الشخصي لن تأثر على حقول ملف العضو الشخصي الموجود سابقًا</strong>',
	'STEP_2_TITLE_CREATE'			=> 'اختيارات محددة لحقل الملف الشخصي',
	'STEP_2_TITLE_EDIT'				=> 'خيارات محددة لحقل الملف الشخصي',
	'STEP_3_EXPLAIN_CREATE'			=> 'بما أنك تملك أكثر من لغة منصبة في المنتدى، عليك ملء بقية بنود اللغة أيضًا. وإن لم تفعل فسيتم استخدام إعدادات اللغة الافتراضية لحقل الملف الشخصي هذا، يمكن ملء بقية بنود اللغات  لاحقًا',
	'STEP_3_EXPLAIN_EDIT'			=> 'بما أنك تملك أكثر من لغة منصبة في المنتدى، تستطيع الآن تعديل أو إضافة بنود اللغة أيضًا. وإلا فسيتم استخدام إعدادات اللغة الافتراضية لحقل الملف الشخصي هذا',
	'STEP_3_TITLE_CREATE'			=> 'تعريفات بقية اللغات',
