...
$lang = array_merge($lang, array(
	...
	'FOUND_SEARCH_MATCHES'		=> array(
		...
		4	=> 'البحث وجد %d تطابقاً',
		5	=> 'البحث وجد %d تطابق',
		),
	'FOUND_MORE_SEARCH_MATCHES'		=> array(
		1	=> 'البحث وجد أكثر من تطابق واحد',
		2	=> 'البحث وجد أكثر من تطابقان',
		3	=> 'البحث وجد أكثر من %d تطابقات',
		4	=> 'البحث وجد أكثر من %d تطابقاً',
	...
	'MAX_NUM_SEARCH_KEYWORDS_REFINE'	=> array(
		1	=> 'لقد أدخلت كلمات كثيرة جداً للبحث. يرجى عدم إدخال أكثر من كلمة واحدة.',
		2	=> 'لقد أدخلت كلمات كثيرة جداً للبحث. يرجى عدم إدخال أكثر من كلمتان.',
		3	=> 'لقد أدخلت كلمات كثيرة جداً للبحث. يرجى عدم إدخال أكثر من %1$d كلمات.',
		4	=> 'لقد أدخلت كلمات كثيرة جداً للبحث. يرجى عدم إدخال أكثر من %1$d كلمة.',
		),
	...
	'NO_SEARCH_TIME'		=> array(
		1	=> 'عذراً لكن لا يمكنك استخدام البحث الآن. يرجى المحاولة ثانيةً بعد ثانية واحدة.',
		2	=> 'ذراً لكن لا يمكنك استخدام البحث الآن. يرجى المحاولة ثانيةً بعد ثانيتان.',
		3	=> 'ذراً لكن لا يمكنك استخدام البحث الآن. يرجى المحاولة ثانيةً بعد %d ثوان.',
		4	=> 'ذراً لكن لا يمكنك استخدام البحث الآن. يرجى المحاولة ثانيةً بعد %d ثانية.',
		),
	...
	'TOO_FEW_AUTHOR_CHARS'	=> array(
		...
		2	=> 'يجب عليك تحديد حرفان على الأقل من اسم الكاتب.',
		3	=> 'يجب عليك تحديد %d حروف على الأقل من اسم الكاتب.',
		4	=> 'يجب عليك تحديد %d حرفاً على الأقل من اسم الكاتب.',
