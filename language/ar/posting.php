...
$lang = array_merge($lang, array(
	...
	'WRONG_SIZE'				=> 'أبعاد الصورة ينبغي أن تكون على الأقل %1$s بكسل عرضًا و %2$s بكسل ارتفاعًا وعلى الأكثر %3$s بكسل عرضًا و %4$s بكسل ارتفاعًا. أبعاد الصورة المقدمة هي %5$s بكسل عرضًا و %6$s بكسل ارتفاعًا.',
));
