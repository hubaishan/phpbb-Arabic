 ...
 * @translated by Saeed Hubaishan <https://phpbb-ar.com>
...
$lang = array_merge($lang, array(
	...
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN'	=> 'ليعمل phpBB بشكل صحيح، دالة getimagesize ينبغي أن تكون متوفرة',
	'PCRE_UTF_SUPPORT'					=> 'دعم PCRE UTF-8',
	'PCRE_UTF_SUPPORT_EXPLAIN'			=> 'phpBB لن يعمل إذا كان تركيب PHP لديك غير متوافق مع UTF-8 في امتداد PCRE',
	'PHP_JSON_SUPPORT'					=> 'دعم PHP JSON',
	'PHP_JSON_SUPPORT_EXPLAIN'			=> 'ليعمل phpBB بشكل صحيح، فإنه يجب وجود دعم امتداد PHP JSON.',
	'PHP_MBSTRING_SUPPORT'				=> 'دعم PHP mbstring',
	'PHP_MBSTRING_SUPPORT_EXPLAIN'		=> 'لكي يعمل phpBB بصورة صحيحة ينبغي توفير ملحقة PHP mbstring.',
	...
	'PHP_SUPPORTED_DB_EXPLAIN'			=> 'ينبغي على الأقل أن يكون أحد قواعد البيانات متوافقة مع PHP. إذا كانت موديلات قواعد البيانات غير متوفرة فينبغي عليك الاتصال بمستضيفك',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '<t>هذا مثال على مشاركة في منتديات phpBB.كل شيء يبدو أنه يعمل بشكل ممتاز. تستطيع الآن حذف هذه المشاركة إن أردت أو تعديلها وأكمل ضبط إعدادات منتداك. خلال عملية التنصيب أنشِئ القسم الأول والمنتدى الأول وأُعِدّت صلاحيات مناسبة من أجل المجموعات إذا قررت أن تحذف هذا القسم لا تنسَ أن تعيد الصلاحيات إلى كل المجموعات التي ستنشئها. من الأفضل أن تعيد تسمية القسم الأول والمنتدى الأول وتنسخ الصلاحيات منهما حين تنشئ أقسامًا أو منتديات جديدة.</t>',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'عن طريق هذا الخيار، سيكون من الممكن تحديث تركيب منتداك phpBB إلى آخر نسخة.<br />أثناء التقدم ستُفحص ملفاتك كلها. ستتمكن من فحص الاختلافات والملفات كلها قبل البدء بتحديثها.<br /><br />ملف التحديث نفسه يستطيع أن ينتهي على طريقتين مختلفتين.</p><h2>التحديث اليدوي</h2><p>مع هذا التحديث ليس عليك سوى تحميل مجموعة الملفات الخاصة بالتعديل للتأكد من أنك لن تفقد ملفاتك المعدلة عند القيام بذلك. بعد تحميل هذه الصفحة تحتاج إلى تحميل الملفات يدويا إلى المسار الصحيح في phpBB ستكون مرحلة الفحص مرة أخرى لنرى إذا كان وُضعَت الملفات في الموقع الصحيح</p><h2>تحديث مطور بواسطة FTP</h2><p>هذه الطريقة مشابهة للأولى ولكن من دون الحاجة إلى تحميل الملفات وتحميل الملفات المتغيرة، وسيتم ذلك لك! من أجل استخدام هذه الطريقة تحتاج لمعرفة التفاصيل الخاصة بك منذ دخول FTP سوف يطلب تسجيل الدخول منك بالنسبة لها. وبمجرد الانتهاء سوف تنتقل إلى التحقق من الملف مرة أخرى للتأكد من استكمال كل ما حصل بشكل صحيح!<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>الطريقة المستحسنة لتحديث تثبيتك هي استخدام الحزمة الكاملة، إذا عُدلت ملفات phpBB الأساسية في تثبيتك فريما ترغب في استخدام حزمة التحديث المتقدم للحفاظ على تعديلاتك، بإمكانك أيضًا التحديث باستخدام الطرق المنصوص عليها في ملف INSTALL.html، خطوات التثبيت باستخدام الحزمة الكاملة هي:</p>
		...
		<h1>كيفية تحديث المنتدى عن طريق حزمة التحديث المتقدم</h1>

		<p>حزمة التحديث المتقدم موصى بها فقط في حالة وجود تعديلات على ملفات phpBB الأساسية في تثبيتك. يمكنك أيضًا تحديث منتداك باتباع إحدى الطرق الموجودة في ملف INSTALL.html. الخطوات لتحديث منتداك آليًا هي:</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li>اذهب إلى <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">صفحة تحميل phpBB.com</a> وقم بتحميل ملف حزمة التحديث المتقدم "Automatic Update Package".</li>
