...
$lang = array_merge($lang, array(
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'مسار تحت مسار المنتدى مثال <samp>images/avatars/upload</samp>.<br>سيكون تحميل الصور الرمزية <strong>معطلاً</strong> إذا كان المسار غير قابل للكتابة.<br>النقاط المزدوجة كهذه <samp>..</samp> سوف تحذف من المسار لأسباب أمنية',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_NAME_EXPLAIN'		=> 'هذا يمكن أن يكون أي شيء تريده، اجعله أصيلاً، وعندما يتم تتغير إعدادات ملفات تعرف الارتباط (الكوكيز) فإنه يجب تغيير الاسم.',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'هذا سعين <samp>Return-Path</samp> (مسار العودة) إلى بريد المرسل بدلاً من اسم المستخدم المحلي واسم الاستضافة للخادم. هذا الإعداد لا يعمل عند استخدام SMTP.<br><em><strong>تحذير:</strong> يتطلب هذا أن يكون مستخدم الخادم معتمد لإعداد خدمة sendmail</em>',
