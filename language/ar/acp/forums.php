...
$lang = array_merge($lang, array(
	...
	'COPY_PERMISSIONS_ADD_EXPLAIN'	=> 'بمجرد إنشائه، هذا المنتدى سيحمل صلاحيات المنتدى نفسه الذي اخترته هنا. إذا لم تختر أي اختيار هنا فالمنتدى الجديد الذي ستنشؤه لن يكون ظاهرًا حتى تحدّد صلاحياته',
	...
	'COPY_TO_ACL'					=> 'اختياري، تستطيع أيضًا %sضبط تصاريح جديدة%s لهذا المنتدى.',
	...
	'FORUM_ADMIN_EXPLAIN'				=> 'في phpBB3 كل شيء عبارة عن منتدى. القسم هو عبارة عن نوع خاص من المنتدى. كل منتدى يمكن أن يحتوي على عدد غير نهائي من المنتديات الفرعية وتحديد ما إذا كان كل واحد يمكن المشاركة فيه أو لا ( بمعنى أن يظهر كـ قسم في النظام القديم ). هنا تستطيع إضافة أو تعديل أو حذف أو غلق أو فتح منتديات محددة كما يمكنك تغيير إعدادات إضافية أخرى. إذا كانت المواضيع والمشاركات قد خرجت عن المطابقة تستطيع إعادة مزامنة المنتدى. <strong>سوف تحتاج إلى نسخ أو أعطاء صلاحيات اولوية للمنتديات الجديدة التي أنشأت لكي تعرَض.</strong>',
	...
	'FORUM_DESC_TOO_LONG'				=> 'وصف المنتدى كبير جدًا، يجب أن يكون أقل من 4000 حرفًا',
	'FORUM_DELETE'						=> 'حذف المنتدى',
	'FORUM_DELETE_EXPLAIN'				=> 'النموذج بالأسفل يسمح لك بحذف المنتدى. إذا كان المنتدى قابلًا للكتابة فيمكنك تحديد أين تريد وضع المواضيع كلها(أو المنتديات) التي يحتوي عليها',
	'FORUM_DELETED'						=> 'حذفَت المنتدى بنجاح',
	'FORUM_DESC'						=> 'الوصف',
	'FORUM_DESC_EXPLAIN'				=> 'إن أدخلت أي أكواد HTML هنا فسوف يتم عرضها كما هي، وإذا كان المنتدى المختار قسمًا فلن يتم استخدام الوصف.',
	...
	'FORUM_IMAGE_EXPLAIN'				=> 'المكان، تبعًا للمجلد الرئيسي للمنتدى، لعرض صورة إضافية لهذا المنتدى',
	'FORUM_IMAGE_NO_EXIST'				=> 'صورة المنتدى المحددة لم توجد',
	'FORUM_LINK_EXPLAIN'				=> 'الرابط كاملًا (محتويًا البروتوكول، مثل: <samp>http://</samp>) للمكان الذي تريد أن يذهب إليه الأعضاء عند الضغط على هذا المنتدى، مثال: <samp>http://www.phpbb.com/</samp>',
	...
	'FORUM_WITH_SUBFORUMS_NOT_TO_LINK'	=> 'تريد تغيير منتدى مشاركات يحتوي على منتديات فرعية إلى رابط. يرجى تحويل المنتديات الفرعية إلى خارج هذا المنتدى قبل المتابعة، لأنه عند تحويل المنتدى إلى رابط لن تقوم بمشاهدة المنتديات الفرعية المتصلة بهذا المنتدى',

	'GENERAL_FORUM_SETTINGS'	=> 'الإعدادات العامة للمنتدى',

	'LINK'						=> 'رابط',
	'LIMIT_SUBFORUMS'			=> 'قصر العرض على المنتديات الفرعية المباشرة',
	'LIMIT_SUBFORUMS_EXPLAIN'	=> 'يقصر المنتديات الفرعية التي يتم عرضها للمنتديات المتفرعة مباشرة من المنتدى الحالي، عند عدم التفعيل سيتم عرض جميع المنتديات المتفرعة مع تفعيل خيار `عرض المنتديات الفرعية أسفل المنتدى الأصل`، بغض النظر عن عمق التفرع.',
	...
	'PRUNE_OLD_POLLS'			=> 'تهذيب الاستطلاعات القديمة',
	'PRUNE_OLD_POLLS_EXPLAIN'	=> 'حذف مواضيع الاستطلاع التي لم يشارك في تصويتها أحد بعد مدة من المشاركة - بالأيام-',
