...
',
	...
	'ACL_SET_EXPLAIN'		=> 'الصلاحيات تعمل على نظام بسيط <samp>نعم</samp>/<samp>لا</samp>. إعطاء القيمة <samp>أبدًا</samp> لإحدى خيارات العضو أو المجموعة سيلغي أية قيمة أخرى معطاة. اذا لم تكن ترغب بإعطاء أية قيمة لإحدى الخيارات فضعها <samp>لا</samp>. بحيث إذا أعطِيَ هذا الخيار قيمة في مكان آخر فسيعتمَد، حتى ولو كانت <samp>أبدًا</samp>. العناصر المحددة جميعها (باستعمال مربع التحديد أمامها) ستستخدم الصلاحيات التي ستعرّفها',
	'ACL_SETTING'			=> 'إعدادات',
	...
	'ALL_NEVER'					=> '<samp>أبدًا</samp> للجميع',
	...
	'ROLE_DESCRIPTION_FORUM_POLLS'			=> 'مثل التصفح المتوسط لكنه يستطيع أيضًا إنشاء الاستفتاءات',
	...
	'TRACE_DEFAULT'					=> 'افتراضيًا كل صلاحية خيارها <samp>لا</samp> (غير معطاة). لذا الصلاحية يمكن أن تستبدل بإعدادات أخرى',
	'TRACE_FOR'						=> 'التتبع لـ',
	'TRACE_GLOBAL_SETTING'			=> '(عام) %s',
	'TRACE_GROUP_NEVER_TOTAL_NEVER'	=> 'صلاحيات هذه المجموعة تغيرت إلى <samp>ابدًا</samp> كمجموع للنتيجة إذن النتيجة السابقة احتفِظ بها',
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'صلاحية المجموعة في هذا المنتدى هي <samp>أبدًا</samp> مثل مجموع النتيجة لذا يحتفظ بالنتيجة القديمة',
	'TRACE_GROUP_NEVER_TOTAL_NO'	=> 'صلاحيات هذه المجموعة تغيرت إلى <samp>أبدًا</samp> لأن مجموع القيمة الجديدة لم يتغير (غيّر إلى <samp>لا</samp>)',
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'صلاحية المجموعة في هذا المنتدى هي <samp>أبدًا</samp> التي توافق قيمة المجموع الجديد لأنها لم تتحدد بعد (اضغط على <samp>لا</samp>)',
	'TRACE_GROUP_NEVER_TOTAL_YES'	=> 'صلاحيات هذه المجموعة تغيرت إلى <samp>أبدًا</samp> مما يؤدي إلى استبدال جميع الـ <samp>نعم</samp> إلى <samp>أبدًا</samp> لهذا العضو',
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'صلاحية هذه المجموعات في هذا المنتدى هي <samp>أبدًا</samp> الذي يستبدل المجموع <samp>نعم</samp> لـ <samp>ابدًا</samp> لهذا العضو',
	...
	'TRACE_GROUP_YES_TOTAL_NEVER'	=> 'تغيرت صلاحيات هذه المجموعة إلى <samp>نعم</samp> لكن في المجموع <samp>أبدًا</samp> لا يمكن استبدالها',
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'	=> 'صلاحية هذه المجموهات لهذا المنتدى تغيرت إلى <samp>نعم</samp> لكن المجموع هو <samp>ابدًا</samp> لا يمكن تغييره',
	...
	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> 'تغيرت صلاحيات العضو للمنتدى المستقلة إلى <samp>نعم</samp> ولكن مجموع الصلاحيات مازال مضبوطًاَ على <samp>نعم</samp>، لذا فالمجموع الحاصل سيحفظ. %sتتبع الصلاحيات العامة%s',
	...
	'TRACE_USER_NEVER_TOTAL_NEVER'			=> 'صلاحيات العضو مضبوطة على <samp>أبدًا</samp> ومجموع القيمة ضبط على <samp>أبدًا</samp>، لذا فلا شيء تغير',
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'صلاحيات هذا المنتدى مضبوطة على <samp>أبدًا</samp> ومجموع القيمة ضبط على <samp>أبدًا</samp>، لذا فلا شيء تغير',
	'TRACE_USER_NEVER_TOTAL_NO'				=> 'صلاحيات العضو مضبوطة على <samp>أبدًا</samp> حيث أصبحت القيم جميعها كذلك بسبب أنه ضُبِط على لا',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'صلاحيات العضو من لهذا المنتدى مضبوطة على <samp>أبدًا</samp> بحيث أصبحت مجموع القيمة بسبب أنه ضُبِط على لا',
	'TRACE_USER_NEVER_TOTAL_YES'			=> 'صلاحيات العضو مضبوطة على <samp>أبدًا</samp> وغطت السابق <samp>نعم</samp>',
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> 'صلاحيات العضو من لهذا المنتدى مضبوطة على <samp>أبدًا</samp> وغطت السابق <samp>نعم</samp>',
	'TRACE_USER_NO_TOTAL_NO'				=> 'صلاحيات العضو هي <samp>لا</samp> ومجموع القيمة ضُبِط على لا لذا أصبحت <samp>أبدًا</samp> افتراضية',
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'صلاحيات العضو من لهذا المنتدى هي <samp>لا</samp> ومجموع القيمة ضُبِط على لا لذا أصبحت <samp>أبدًا</samp> افتراضية',
	'TRACE_USER_YES_TOTAL_NEVER'			=> 'صلاحيات العضو مضبوطة على <samp>نعم</samp> ولكن المجموع <samp>أبدًا</samp> لا يمكن تغطيته',
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'صلاحيات العضو من لهذا المنتدى مضبوطة على <samp>نعم</samp> ولكن المجموع <samp>أبدًا</samp> لا يمكن تغطيته',
