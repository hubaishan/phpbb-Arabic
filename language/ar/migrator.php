...
$lang = array_merge($lang, array(
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'حدث  خطأ أثناء العمل وتم عمل استثناء. التغييرات التي حدثت قبل وقوع الخطأ تم عكسها على قدر المستطاع، ولكن يجب عليك فحص المنتدى بحثًا عن أخطاء::<br><br>%s',
