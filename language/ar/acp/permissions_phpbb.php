...
$lang = array_merge($lang, array(
	...
	'ACL_U_EMOJI'		=> 'بإمكانك استخدام رموز إيموجي والنص الغني في عنوان الموضوع',

	'ACL_U_SENDPM'		=> 'يمكنه إرسال رسائل خاصة',
	'ACL_U_MASSPM'		=> 'يمكنه إرسال رسائل خاصة إلى عدة مستخدمين',
	'ACL_U_MASSPM_GROUP'=> 'يمكنه إرسال رسائل خاصة إلى مجموعات',
...
$lang = array_merge($lang, array(
	...
	'ACL_F_LIST_TOPICS' => 'يمكنه رؤية المواضيع',
	'ACL_F_READ'		=> 'يمكنه قراءة المنتدى',
	'ACL_F_SEARCH'		=> 'يمكنه البحث في المنتدى',
	'ACL_F_SUBSCRIBE'	=> 'يمكنه متابعة المنتدى',
...
$lang = array_merge($lang, array(
	...
	'ACL_A_STYLES'		=> 'يمكنه إدارة الاستايلات',
