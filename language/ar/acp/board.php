...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'		=> 'التفاصيل هنا تضبط البيانات التي تستعمل لإرسال ملفات تعريف الارتباط (الكوكيز) إلى متصفح المستخدم. الإعدادت الافتراضية تفي بالغرض في أغلب الأحوال . لكن إذا أردت أن تقوم بتعديلات اعملها بحذر. الإعدادت الخاطئة قد تمنع المستخدمين من تسجيل الدخول،  إذا كان لديك مشاكل عن أعضاء لا يزالون مسجلي الدخول زُر <strong><a href="https://www.phpbb.com/support/go/cookie-settings">phpBB.com قاعدة معلومات - إصلاح إعدادات كوكي غير سليمة (بالإنجليزية(</a></strong>',

	'COOKIE_DOMAIN'				=> 'نطاق ملفات تعريف الارتباط (الكوكيز)',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'في معظم الأحوال نطاق ملفات تعربف الارتباط (الكوكيز) اختياري، اتركه فارغا إذا كنت غير متأكد.<br><br> في حالة إذا كان المنتدى مندمجا مع برامج أخرى أو كان لديه أكثر من نطاق فلكي تعرف نطاق ملفات تعريف الارتباط افعل الآتي: إذا كان لديك مثلا <i>example.com</i> و <i>forums.example.com</i>، أو <i>forums.example.com</i> و <i>blog.example.com</i>. أزل النطاقات الفرعية حتى يبقى النطاق المشترك <i>example.com</i>.أضف الآن نقطة في بداية النطاق المشترك في مثالنا .example.com (لاحظ النقطة في البداية).',
	'COOKIE_NAME'				=> 'اسم ملفات تعريف الارتباط (الكوكيز)',
	'COOKIE_NAME_EXPLAIN'		=> 'هذا يمكن أن يكون أي شيء تريده، اجعله أصيلًا، وعندما يتم تتغير إعدادات ملفات تعرف الارتباط (الكوكيز) فإنه يجب تغيير الاسم.',
	'COOKIE_NOTICE'				=> 'تنبيه ملفات تعريف الارتباط (الكوكيز)',
	...
	'COOKIE_PATH'				=> 'مسار ملفات تعريف الارتباط (الكوكيز)',
	'COOKIE_PATH_EXPLAIN'		=> 'لاحظ أنها دائمًا شرطة مائلة بغض النظر عن مسار منتداك.',
	'COOKIE_SECURE'				=> 'ملفات تعريف ارتباط (كوكيز) آمنة',
