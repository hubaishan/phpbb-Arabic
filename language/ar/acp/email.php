...
$lang = array_merge($lang, array(
	...
	'EMAIL_SENT_QUEUE'		=> 'تخزنت الرسالة لإرسالها لاحقًا.',

	'LOG_SESSION'			=> 'وضع سجلات البريد ضمن السجلات الحرجة.',

	'SEND_IMMEDIATELY'		=> 'الإرسال فوريًا',
