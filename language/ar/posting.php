...
$lang = array_merge($lang, array(
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		1	=> 'ملفات الفلاش يجب أن لا يزيد ارتفاعها عن %d بكسل.',
		2	=> 'ملفات الفلاش يجب أن لا يزيد ارتفاعها عن %d بكسل.',
		),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> 'ملفات الفلاش يجب أن لا يزيد عرضها عن %d بكسل.',
		2	=> 'ملفات الفلاش يجب أن لا يزيد عرضها عن %d بكسل.',
		),
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> 'الصور يجب أن لا يزيد ارتفاعها عن %1$d بكسل.',
		2	=> 'الصور يجب أن لا يزيد ارتفاعها عن %1$d بكسل.',
		),
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> 'الصور يجب أن لا يزيد عرضها عن %d بكسل.',
		2	=> 'الصور يجب أن لا يزيد عرضها عن %d بكسل.',
		),

	'MESSAGE_BODY_EXPLAIN'		=> array(
		0	=> '',	// zero means no limit, so we don't view a message here.
		1	=> 'أدخل رسالتك هنا، يجب أن لا تحتوي على أكثر من حرف واحد.',
		2	=> 'أدخل رسالتك هنا، يجب أن لا تحتوي على أكثر من حرفان.',
		3	=> 'أدخل رسالتك هنا، يجب أن لا تحتوي على أكثر من <strong>%d</strong> حروف.',
		4	=> 'أدخل رسالتك هنا، يجب أن لا تحتوي على أكثر من <strong>%d</strong> حرفاً.',
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال خيار واحد.',
		2	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى خياران.',
		3	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى <strong>%d</strong> خيارات.',
		4	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى <strong>%d</strong> خياراً.',
		5	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى <strong>%d</strong> خيار.',
		),
	'POLL_OPTIONS_EDIT_EXPLAIN'		=> array(
		1	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال خيار واحد. إذا قمت بحذف أو إضافة خيارات، سيتم تصفير جميع الأصوات الماضية.',
		2	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى خياران. إذا قمت بحذف أو إضافة خيارات، سيتم تصفير جميع الأصوات الماضية.',
		3	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى <strong>%d</strong> خيارات. إذا قمت بحذف أو إضافة خيارات، سيتم تصفير جميع الأصوات الماضية.',
		4	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى <strong>%d</strong> خياراً. إذا قمت بحذف أو إضافة خيارات، سيتم تصفير جميع الأصوات الماضية.',
		5	=> 'أدخل كل خيار في سطر جديد. يمكنك ادخال حتى <strong>%d</strong> خيار. إذا قمت بحذف أو إضافة خيارات، سيتم تصفير جميع الأصوات الماضية.',
		),
	...
	'QUOTE_DEPTH_EXCEEDED'		=> array(
		...
		2	=> 'يمكنك وضع اقتباسان فقط بداخل بعضهما.',
		3	=> 'يمكنك وضع %d اقتباسات فقط بداخل بعضهم.',
		4	=> 'يمكنك وضع %d اقتباساً فقط بداخل بعضهم.',
	...
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1	=> 'يجب أن تدخل على الأقل حرفاً واحداً.',
		2	=> 'يجب أن تدخل على الأقل حرفان.',
		3	=> 'يجب أن تدخل على الأقل %1$d حروف.',
		4	=> 'يجب أن تدخل على الأقل %1$d حرفاً.',
